...
import com.example.lifeguard.adapter.firstGuideAdapter;
...
public class FirstUserGuideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finishG = findViewById(R.id.finishG);
        finishG.setOnClickListener(new View.OnClickListener() {
            @Override
